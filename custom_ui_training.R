...
jumbotron <- function(...,
    ...
    if (is.null(background_img)) {
      ...
      style_jumbotron <- str_glue(
          "background-image:url('{background_img}'); background-size:cover;",
      )   
    }
    ...
    div(
        ...
        div(
            ...
            style = str_glue(
                "color:{ui_box_text_color}; background-color:{ui_box_bg_color}; padding:25px;",    
            ),
...
info_cards <- function(title, value, sub_value,
...
ui <- fixedPage(
    ...
    div(
        ...
        column(
            ...
            div(
                ...
                div(
                    ...
                    h4("AAPL"),
                    h5(HTML("20-Days <small>vs 50-Days</small>")),
                    p(
                        class = "text-success",
                        icon("arrow-up"),
                        tags$small("20%")
        ...
        column(
            ...
            info_cards(
                title = "NFLX",
                value = p("20-Days", tags$small("vs 50-Days")),
                sub_value = "-10%",
                sub_icon = "arrow-down",
